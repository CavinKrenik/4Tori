...
- smooth inner layer that repels blood cells & platelets
...
- Function is exchange of nutrients & wastes between blood
...
- Venules
- proximal venule is quite porous, exchanges fluid

# with tissues,  like a capillary, at this point only

- Venous sinuses: veins with thin walls, large

# lumens, no smooth muscle

- Veins have lower blood pressure: avg..

# 10mmHg with little fluctuation

- thinner walls, less muscular and elastic tissue
- expand easily, have high capacitance
- venous valves aid skeletal muscles in upward
...
# smooth muscle cells & scattered


# fibroblasts

- very porous endothelium allows for escape

# of many phagocytic white blood cells

- Venules that approach size of veins

# more closely resemble structure of vein
...
- Anastomosis = point where

# 2 blood vessesl merge
...
- transcytosis
- passage of material across endothelium in tiny

# vesicles by endocytosis and exocytosis
...
- reabsorption is movement from interstitial fluid into
...
- Pinocytosis, transport vesicles across the cell,
...
# into capillary (same on both ends)
...
- Starling’s law of the capillaries is that the volume of fluid &

# solutes reabsorbed is almost as large as the volume filtered
...
- net outward pressure of 10 mm Hg at

# arterial end of a capillary bed

- net inward pressure of 9 mm Hg at venous

# end of a capillary bed

- About 85% of the filtered fluid is

# returned to the capillary

- escaping fluid and plasma proteins are

# collected by lymphatic capillaries (3
...
- Circulation time is time it takes a drop of blood

# to travel from right atrium back to right atrium
...
- Prehypertension 120-129/80-89 either/or
- Hypertension I 130-159/90-99 either/or
- Hypertension II over 160/100 either/or
...
- Better indicator of perfusion than blood

# pressure

- Low below 60 = inadequate perfusion
- High above 100 = too much resistance
...
- Systemic vascular resistance is the total of

# above

- arterioles control BP by changing diameter

# Laminar Flow and Vessel


# Radius


# Small radius = average
...
- if r = 3 mm, F = (34) = 81 mm/sec; if r = 1
...
- greater distance traveled, more friction to 

# flow

- smaller radii of arterioles and capillaries
- farther from the heart, greater the total cross
...
- Thoracic pump
- inhalation - thoracic cavity expands (pressure ) abdominal

# pressure , forcing blood upward
...
# to deliver enough O2 and nutrients
...
- Any state where cardiac output insufficient
...
- loss of blood volume: trauma, bleeding, burns,

# dehydration

- obstructed venous return shock - tumor or
...
# Responses to Circulatory


# Shock

- Compensated shock
- Homeostatic Mechanisms of compensation in shock

# attempt to return cardiac output & BP to normal
...
- If blood volume drops by 10-20% or if BP does not

# rise sufficiently, perfusion may be inadequate --


# cells start to die


# Restoring BP during Hypovolemic
...
- Weak, rapid pulse due to reduced cardiac output &

# fast heart rate

- Clammy, cool skin due to cutaneous

# vasoconstriction

- Sweating -- sympathetic stimulation
- Altered mental state due to cerebral ischemia
- Reduced urine formation -- vasoconstriction to

# kidneys & increased aldosterone & antidiuretic
...
# Output from the Cardiovascular
...
- Angiotensinogen (prohormone produced by
...
# vessel diameter (K+, H+, lactic acid, nitric oxide)
...
- if CO2 (hypercapnia) in brain, pH , triggers vasodilation
- hypocapnia  pH, vasoconstriction, occurs with hyperventilation,

# may lead to ischemia, dizziness and sometimes syncope
...
# disease and atherosclerosis more likely
...
- Lymph
- clear, colorless fluid, similar to plasma but much less
...
- Lymphatic nodules: dense oval masses of

# lymphocytes, congregate in response to pathogens
...
- Secondary tumor sites can be predicted by direction

# of lymphatic flow from primary site
...
- Palatine tonsils
- pair at the posterior margin of oral cavity; most
...
- Immediate protection against wide variety of
...
- acidic pH of gastric juice and vaginal secretions destroys
...
- histiocytes in the skin, kupffer cells in the liver, alveolar macrophages in
- the lungs, microglia in the brain & macrophages in spleen, red marrow &
...
- swelling (edema) caused by capillary permeability and

# filtration

- heat caused by hyperemia
- pain caused by inflammatory chemicals (bradykinin,

# prostaglandins) secreted by damaged cells, pressure on nerves


# Mobilization of Defenses

- Bradykinin, histamine and leukotrienes are

# secreted by damaged cells, basophils (blood) and


# mast cells (tissue)

- stimulates vasodilation that leads to hyperemia
- causes redness and heat:local metabolic rate, promotes

# cell multiplication and healing

- dilutes toxins, provides O2, nutrients, waste removal
- stimulates permeability of blood capillaries
- allows blood cells, plasma chemicals (antibodies,
...
- margination
- leukocytes adhere to blood

# vessel walls (cell adhesion
...
- Fibrinogen now in tissue clots, trapping microbes
- Heparin prevents clotting at site of injury
- pathogens trapped in a fluid pocket surrounded by
...
- Edema venous flow, lymphatic flow that

# favors removal of bacteria and debris
...
# area secrete a cytokine, PDGF, that stimulates


# fibroblasts to multiply and synthesize collagen
...
- Derived from T-lymphocyte precursor
- Specialized for self from funky self
...
- Interferons: polypeptides secreted by cells

# invaded by viruses

- antiviral effect
- generalized protection
- interferons diffuse to neighboring cells and stimulate
...
- Pathways of complement activation (see next
...
- Complement proteins C5b to C9 form ring in

# plasma membrane of enemy cell causing cytolysis


# Fever

- Defense mechanism: can do more good than
...
- A cytokine, interleukin 1 is called a pyrogen
...
- Immunity is bodies ability to defend itself against

# specific foreign material or organisms
...
- Immune system is cells and tissues that produce the
...
- helper cells costimulate T and

# B cells

- effective against fungi, viruses,

# parasites, cancer, and tissue
...
# gene segments that codes its unique


# antigen receptor in the cell membrane
...
- MHC-I molecules are built into cell membrane of all cells except

# red blood cells

- MHC-II markers seen only on membrane of antigen presenting

# cells (macrophages, B cells, thymus cells)

- Function
- if cell is infected with virus MHC-I contain bits of virus marking cell so T

# cells recognize is problem
...
- Helper T cells “see” antigens if part of MHC-II molecules on surface

# of antigen presenting cell

- Cytotoxic T cells “see” antigens if part of MHC-I molecules on surface
...
- Fragments of weird proteins become part

# of MHC-I molecules displayed at surface of
...
- Stem cells of fetus colonize thymus for 2-3
...
- immunocompetent cell: antigen receptors in
...
# bind to Reticular Epithelium cell
...
# Failing either of these results in negative selection
...
# clonal deletion: destruction of offending T cell clones
...
# leaves the body in a state of self-tolerance

- 

# 1 in 100 emerge immunocompetent
...
# 1. bind to MHC on Reticular Epithelium cell


# 2. not react to self antigens


# divide rapidly and form a clone of T cells


# with identical receptors for antigen

- 

# These cells leave thymus to colonize
...
# 1. Cytotoxic (killer) T cells: carry out attack


# 2. Helper T cells: help promote T cell and B cell


# action and nonspecific defense mechanisms


# 3. Suppressor T cells: limit cell mediated attack


# 4. Memory T cells: provide immunity from
...
- Cytotoxic T cells migrate to site

# of infection or tumor formation

- Recognize, attach & attack
- secrete granules containing

# perforin that punch holes in target
...
- Tumor necrosis factor kills cancer
...
- Cancerous cell displays weird surface antigens (tumor
...
# suffer most from viral-induced cancers
...
- B cells & macrophages, display antigens to T cells
...
# abnormal peptides ingested and displayed
...
# feedback effect causes formation of many more helper T
...
- As pathogen disappears, slows down immune
...
- Millions of different B cells that can recognize different
...
- combines with epitope on antigen similarly to key fits a specific
...
- Antibody enters the circulation
...
- IgE: monomer; tonsils, skin, mucous membranes;

# stimulates release of histamines, attracts eosinophils

- IgG: monomer; 75-85% circulating, crosses placenta to

# fetus, secondary immune response, binds complement

- IgM: monomer; B cell membrane, antigen receptor;

# pentamer in plasma, 1 immune response, agglutination


# Antibody Diversity

- Immune system produces as many as 2 million
...
- Neutralization of antigen by blocking effects of toxins

# or preventing its attachment to body cells

- Immobilize bacteria by attacking cilia/flagella
- Agglutinate & precipitate antigens by cross-linking

# them causing clumping & precipitation
...
- different antibodies will exist for the different epitopes on
...
- Excessive immune reaction against antigens that most

# people tolerate - allergens

- Type I (acute) hypersensitivity (most common)
- anaphylaxis: occurs in sensitized people, allergen caps

# IgE on mast cells, basophils; release inflammatory


# chemicals, cause local edema, mucus hypersecretion,


# congestion; hives, watery eyes, runny nose are typical

- Asthma (most common chronic illness in children)
- inhaled allergens, histamines, bronchiole constriction
- Anaphylactic shock: bronchiolar constriction, dyspnea,

# vasodilation, shock, death; treatment- epinephrine
...
- IgG or IgM binds to antigens on cells and lyses

# them through complement fixation;


# transfusion reaction

- IgG or IgM binds to cell surface receptors and

# either interferes with (myasthenia gravis,


# erythroblastosis fetalis) or overstimulates cell
...
# Poison Oak CD8 cell activation due to haptens


# Type IV Hypersensitivity (Delayed)

- 12 to 72 hour delay
- APC’s in lymph nodes display antigens to helper T

# cells, which secrete interferon and lymphokines


# that activate cytotoxic T cells and macrophages
...
- invades helper T cells, macrophages and dendritic

# cells by “tricking” them to internalize viruses by


# receptor mediated endocytosis

- reverse transcriptase (retrovirus), uses viral RNA

# as template to synthesize DNA, new DNA inserted


# into host cell DNA, may be dormant for months to
...
- progresses to night sweats, fatigue, headache, extreme

# weight loss, lymphadenitis

- normal TH count is 600 to 1,200 cells/L of blood but in

# AIDS it is < 200 cells/L

- person susceptible to opportunistic infections (Toxoplasma,

# Pneumocystitis, herpes simplex virus, CMV or TB
...
- Undamaged latex condom is an effective barrier
...
- six regulate the anterior pituitary and two
...
- releasing hormones stimulate the pituitary

# to release hormones of its own (TRH, CRH,
...
- inhibiting hormones suppress pituitary

# secretion of hormones (PIH and GHIH)
...
# are stored and released by the posterior


# pituitary neuronally


# The Hypothalamus and Pituitary Gland

- six hormones are produced by the hypophysis
...
# the development of ovarian follicles and
...
# in females and the secretion of testosterone
...
- thyroid-stimulating hormone (TSH), or thyro-

# tropin stimulates the growth of the thyroid


# gland and secretion of thyroid hormone
...
# corticotropin targets the adrenal cortex to
...
- prolactin (PRL) stimulates the mammary

# glands to grow and to synthesize milk after
...
# corticotropin targets the adrenal cortex

- prolactin (PRL) stimulates the mammary

# glands to grown and synthesize milk after
...
- oxytocin (OT) surges in both sexes during

# sexual arousal, stimulates labor con-


# tractions, and flow of milk during lactation,


# lowers stress, stimulates baby/mom bonding


# The Hypothalamus and Pituitary Gland

- the two posterior lobe hormones are oxytocin
...
# retention by the kidneys, reduces urine
...
- thyroid gland is the largest adult gland to have

# a purely endocrine function
...
- histologically, thyroid is composed mostly of
...
- thyroid follicles are filled with colloid and lined

# with follicular cells (secrete TH: T3 and T4).


# Thyroid hormone (TH) stimulates increased
...
- thyroid gland also contains nests of parafol-

# licular cells or clear (C) cells at the periphery
...
- clear cells secrete calcitonin which decreases

# blood Ca++ level by  stimulating


# osteoblast activity, promoting calcium


# deposition and bone formation in children
...
- parathyroid glands are ovoid glands, usually

# four in number, partially embedded in the
...
# posterior surface of the thyroid. Unlike the


# thyroid, parathyroid glands are not regulated


# but pituitary, but monitor blood directly.

- chief cells secrete parathyroid hormone (PTH),

# while oxyphil cells are non secretory
...
# while clear cells are non secretory

- PTH raises blood Ca2+ levels by stimulating
...
- thymus secretes thymosin, which stimulates T-
...
- pancreas is comprised of acinar cells (have

# exocrine function -- digestive enzymes) and


# pancreatic islet cells or islets of Langerhans


# The Pancreas

- pancreas is comprised of acinar cells (digestive

# enzymes) and pancreatic islet cells or islets
...
# Insulin – secreted due to detected blood glucose


# level and stimulates glyconeogenesis in


# hepatocytes and lipogenesis in adipose tissue,


# while lipolysis, glycongenolysis and
...
- pineal gland is found in the epithalamus and
...
- adrenal (suprarenal) glands sit like a cap on

# the superior pole of each kidney

- comprised of an outer cortex (80-90%) and
...
- adrenal cortex surrounds the medulla on all

# sides and produces more than 25 steroids


# The Adrenal Glands

- adrenal cortex has three layers of tissue
- zona glomerulosa is the source of

# mineralocorticoids (aldosterone – K+/Na+
...
- zona fasciculata is the source of gluco-

# corticoids (cortisol or hydrocortisone)
...
- adults generally have 4-6 liters of blood
- liquid connective tissue in which the matrix is

# blood plasma (clear, light yellow fluid)
...
- formed elements include RBCs, platelets (cell
...
- WBCs are divided into granulocytes (baso-

# phils, eosinophils, and neutrophils) and
...
- type O blood is the most common and AB is
...
# donor’s RBCs not agglutinate as they enter


# the recipient’s bloodstream

- a mismatch causes a transfusion reaction
- agglutinated RBCs block small blood

# vessels, hemolyze, and release their Hb

- type AB is called the universal recipient and
...
- the heart wall consists of three layers
- epicardium (visceral layer of the serous peri-

# cardium) is a serous membrane of the
...
# chambers, covers the valve surfaces, and is
...
- base of the heart is superior where the great

# vessels are attached

- apex of the heart is at the inferior end, just
...
- two superior chambers are the right and left

# atria (receive blood returning to the heart)

- each atrium has an earlike flap called an

# auricle that slightly increases volume
...
- ligamentum arteriosum is a remnant of the
...
- atria exhibit thin flaccid walls and pectinate

# muscles due to their light workload
...
- two inferior chambers, the right and left

# ventricles, are pumps that eject blood into


# the arteries

- ventricles are separated by a thick muscular
...
- right AV (tricuspid) valve has three cusps and

# the left AV (mitral) has two
...
- tendinous cords (chordae tendineae) connect

# the valve cusps to papillary muscles and


# prevent valves from flipping inside out


# Cardiac Anatomy

- the semilunar valves regulate the flow of

# blood from the ventricles into the arteries

- pulmonary valve controls the opening from

# the right ventricle into the pulmonary trunk

- aortic valve controls the opening from the left
...
- after the aorta leaves the left ventricle, it gives

# off a right and left coronary artery

- left coronary artery (LCA) travels through the

# coronary sulcus and divides
...
- anterior interventricular branch runs down

# the sulcus and up the posterior side

- aka left anterior descending (LAD) branch
...
- aka left anterior descending (LAD) branch
- circumflex branch continues around the left

# side of the heart in the coronary sulcus
...
- right coronary artery (RCA) travels through the
...
- right marginal branch runs toward the apex
...
- right marginal branch runs toward the apex
- posterior interventricular branch travels down
...
- great cardiac vein collects blood from the

# anterior aspect of the heart and travels


# along the anterior interventricular artery

- small cardiac vein travels up the left side
...
# vein collects blood from the posterior heart

- coronary sinus is in the coronary sulcus on the

# posterior side of the heart (collects blood


# from all veins and empties into right atrium)
...
- sinoatrial (SA) node is a patch of modified

# cardiomyocytes in the right atrium

- SA node is the pacemaker that initiates each
...
# the lower end of the interatrial septum near
...
- the atrioventricular (AV) bundle is the path-

# way by which signals leave the AV node


# Cardiac Conduction

- AV bundle forks into right and left bundle

# branches, which enter the interventricular


# septum and descend toward the apex
...
- the subendocardial network consists of

# processes that arise from the lower end of
...
- an electrocardiogram (ECG or EKG) measures
...
- the P wave is produced when a signal from

# the SA node spreads through the atria and


# depolarizes them (.25 mV and .12 s)
...
- the QRS complex is produced when the signal

# from the AV node spreads through the
...
- the T wave is generated by ventricular

# repolarization immediately before diastole
...
- arteries carry blood away from the heart
- veins carry blood back to the heart
- capillaries are microscopic, thin-walled vessels

# that connect the smallest arteries to the
...
- walls of arteries and veins are composed of

# three layers called tunics

- tunica interna (tunica intima) lines the inside

# of the vessel (exposed to blood)
...
# that acts as a selectively permeable barrier
...
- tunica media is the middle and usually the

# thickest layer

- consists of smooth muscle, collagen and
...
- tunica externa (tunica adventitia) is the

# outermost layer consisting of areolar


# connective tissue

- anchors the vessel to adjacent tissues and

# provides passage for small nerves, lym-


# phatic vessels and smaller blood vessels
...
- vasa vasorum is a network of small vessels

# that nourish the deeper tissues of a larger
...
- conducting (elastic or large) arteries are the

# biggest (aorta, common carotid and


# subclavian arteries, pulmonary trunk and
...
# are smaller branches that distribute blood


# to specific organs

- include brachial, femoral, and renal arteries
...
# Exercise 16: Blood Pressure & Lymphatic


# Blood Pressure

- cardiac cycle is a contraction (systole) and

# relaxation (diastole) of the heart (about .8s)

- dicrotic notch is a small secondary pressure

# increase in the beginning of diastole

- first and second heart sounds (S1 and S2) are

# often described as “lubb-dupp” and are due


# to closing of the valves

- pulse pressure - difference between systolic

# and diastolic pressures (about 40 mmHg)
...
# “Taking a Blood Pressure” Activity

- To begin, place the cuff on your bare upper arm one inch above the bend
- of your elbow. Pull the end of the cuff so that it's evenly tight around your
- arm. You should place it tight enough so that you can only slip two

# fingertips under the top edge of the cuff.

- Once the cuff is on, place the disk of the stethoscope facedown under the

# cuff, just to the inner side of your upper arm.

- Next, place the stethoscope earpieces in your ears, with the earpieces
- facing forward, pointing toward the tip of your nose. Rest the gauge in the
- open palm of the hand of your cuffed arm so that you can clearly see it.
- Then, squeeze the pump rapidly with your opposite hand until the gauge
- reads 30 points above your usual systolic pressure. (Be sure to inflate the
- cuff rapidly). Stop squeezing. Turn the knob on the pump toward you

# (counterclockwise) to let the air out slowly.


# Lymphatic System

- lymphatic system has three functions
- fluid recovery (excess fluid from interstitial

# space is reabsorbed - 15% - and returned to
...
- immunity (tissue fluid is filtered through

# lymph nodes with immune cells on its way
...
- lipid absorption by lacteals in small intestine

# Lymphatic Organs

- thymus is a bilobed organ located between
...
- spleen is in the left hypochondriac region,

# inferior to the diaphragm and posterolateral
...
- lymph nodes are the most numerous

# lymphatic organs (about 450 in adult)
...
- lymph flows through a series of lymphatic
...
- right lymphatic duct is formed by the con-

# vergence of the right jugular, subclavian,
...
- thoracic duct drains from a sac called the

# cisterna chyli and empties into the left
...
- appendix contains abundant lymphatic
...
- Venipuncture
- sample taken from vein with hypodermic
...
- common technique for diabetics to monitor
...
- Plasma is a mixture of water (>90%), proteins (7%),

# enzymes, nutrients, wastes, hormones,


# electrolytes, and gases (2% total)
...
- Injecting previously stored RBC’s before an
...
- Most cells need continual replacement due to life spans of

# hours to weeks

- Hemopoietic tissues produce blood cells
- yolk sac in vertebrate embryo produce stem cells that colonize fetal
...
# (thymus, tonsils, lymph nodes, spleen & peyers patches in intestines)
...
- In adults only in flatbones like sternum, ribs, skull, pelvis, head of femur
...
# in treating decreased RBC production of end-
...
- New RBC’s enter circulation at the rate of 2
...
- Should be .5 to 1.5% of the circulating

# RBC’s

- Low count in an anemic person might
...
- High count might indicate recent blood loss

# or successful iron therapy
...
- heme portion split into iron (Fe+3) and biliverdin (green
...
- if reabsorbed from intestines into blood is converted to a yellow

# pigment, urobilin and excreted in urine
...
- hemoglobin picks up nitric oxide (NO) & super nitric oxide

# (SNO)& transport it to & from the lungs

- NO causing vasodilation is released in the lungs due to

# CO2 release

- NO causing vasodilation is released in the tissues due to

# O2 release


# Ventilation Adjusts to
...
- RBC count & hemoglobin concentration

# indicate the amount of oxygen the blood can
...
# factor from glands of the stomach (pernicious anemia)
...
# the red blood cells (heterozygote advantage)


# Sickle-Cell Diseased
...
- Red bone marrow stores & releases granulocytes &
...
- ↑ in parasitic infection and allergies
...
- ↑ in chicken pox, diabetes, autoimmune

# disorders, hypersensitivities (allergies)
...
- crowding out of normal red bone marrow cells

# by production of immature WBC
...
- Megakaryoblast repeatedly replicates its

# DNA without dividing

- forms gigantic cell called megakaryocyte (100

# m in diameter that remains in bone marrow)

- Infoldings of megakaryocyte cytoplasm splits

# off cell fragments that enter the bloodstream


# as platelets (live for 10 days)
...
- Functions
- secrete clotting factors, growth factors for endothelial repair,

# and vasoconstrictors in broken vessels
...
- Stopping bleeding in a quick & localized

# manner when blood vessels are damaged

- 3 hemostatic mechanisms all involve
...
- Provides time for other 2 mechanisms to
...
- adenosine diphosphate (ADP) attracts & degranulates more
...
- Positive feedback cycle is active until break in vessel
...
# factor (thromboplastin Factor


# III to activate factor VII) into
...
# platelets come in contact


# with collagen of blood vessel


# wall activating Factor XII
...
- Rapid clotting occurs since each activated

# enzyme produces a large number of enzyme


# molecules in the following step.


# Role of Vitamin K in Clotting

- Normal clotting requires adequate vitamin
...
- pseudopods of platelets contract pulling on fibrin threads

# condensing the clot and pulling the edges together
...
- kallikrein converts plasminogen into plasmin, a fibrin-

# dissolving enzyme or clot buster
...
- Fibrinolytic system dissolves small, inappropriate clots & clots

# at a site of a completed repair
...
- antithrombin produced by the liver deactivates thrombin before it can

# act on fibrinogen

- heparin secreted by basophils & mast cells interferes with formation of
...
- if blood flows too slowly (stasis) allowing clotting factors to build up
...
- At least 26 different groups

# ABO, Rh, Kell, Lewis, Kidd,
...
- responsible for RBC agglutination in mismatched blood
...
# or absence of antigens (agglutinogens) A & B on
...
- you do not have those that would react against your

# own antigens

- each antibody can attach to several antigens at the

# same time causing agglutination (clumping)
...
- problem is donor’s plasma may have antibodies

# against recipient’s red blood cells
...
- Rh- pregnant woman carrying an Rh+ fetus or blood transfusion of

# Rh+ blood

- no problems result with either the first transfusion or the first

# pregnancy, abortion or miscarriage

- hemolytic disease of the newborn (erythroblastosis fetalis) occurs if
- mother has formed antibodies & is pregnant with 2nd Rh+ child or 2nd
...
# In subsequent Rh+ pregnancies mother’s antibodies attack fetal blood


# causing severe anemia & toxic brain syndrome from excessive bilirubin in


# blood

- treatment is phototherapy to degrade bilirubin or exchange transfusion to

# completely replace infant’s blood
...
- Transfer of whole blood, cells or plasma into

# the bloodstream of recipient
...
- only true if cross match the blood for
...
- Clots cause ischemia and necrosis leading
...
- Mechanisms
- gap junctions
- pores in cell membrane along which signalling chemicals
...
- endocrine system reacts slowly (hormone release in seconds or
...
- Area of effect
- nervous system effects are targeted and specific (one organ)
- endocrine system may have general, widespread effects on many
...
- norepinephrine, cholecystokinin, thyrotropin-releasing hormone,

# dopamine and antidiuretic hormone
...
- Exocrine glands
- secrete products into ducts which empty into body cavities
...
- produce hormones
- Endocrine system
- includes endocrine organs (thyroid, pineal, etc)
...
- hormone release in response

# to nervous system signals

- suckling infant→stimulates
...
# Hormones (red box)secreted by anterior pituitary (under control of


# hypothalamic releasers and inhibitors)
...
- half-life of 20 hours compared to 20 minutes for GH
- Functions of GH-IGF
- protein synthesis
-  DNA transciption for  mRNA production, proteins synthesized
- enhances amino acid transport into cells,  protein catabolism
- lipid metabolism
- stimulates FFA and glycerol release from adipocytes, protein spari
- CHO metabolism
...
- Adulthood
- increase osteoblastic activity and

# appositional growth affecting bone thickening


# and remodeling

- blood concentration decrease by age 75 to ¼

# of that of adolescent
...
- Peak secretion 1-5 yr. olds, by puberty 75%
...
# Seasonal Affective Disorder and Jet
...
# when day length is short

- Due to overproduction of melatonin
- Therapy
- exposure to several hours per day of artificial light
...
- Thyroid follicles
- filled with colloid and lined with simple cuboidal epith.

# (follicular cells) that secretes 2 hormones, T3+T4
...
- produce calcitonin that  blood Ca+2, promotes Ca+2
...
- High or low blood levels of Ca+2 stimulate the release

# of different hormones --- PTH or CT
...
- inflammatory effects reduced (skin cream)
...
- 1-2 Million pancreatic islets producing

# hormones

- 98% of organ produces
- digestive enzymes
- (exocrine)
- Insulin (from  cells)
...
- stimulates glycogenolysis, fat catabolism (release of

# FFA’s) and promotes absorption of amino acids for
...
- paracrine secretion = modulates secretion of  +  cells
...
- produces estradiol and progesterone for 12 days

# or 8-12 weeks with pregnancy

- Functions of estradiol and progesterone
- development of female reproductive system and

# physique including bone growth

- regulate menstrual cycle, sustain pregnancy
- prepare mammary glands for lactation
- Both secrete inhibin: suppresses FSH
...
- Interstitial cells (between seminiferous
...
- secrete inhibin which suppresses FSH

# secretion which stabilizes sperm production
...
- Skin
- keratinocytes help produce D3, first step in synthesis
- Liver
- converts vitamin D3 to calcidiol
- source of IGF-I that works with GH
...
-  absorption by intestine and inhibits loss in the urine
- more Ca+2 available for bone deposition
...
- smooth muscle contraction, glandular secretion, blood

# flow, platelet function, nerve transmission, metabolism
...
- Monoamines and peptides are hydrophilic so mix

# easily with blood plasma
...
- albumin, thyretin and TGB (thyroxine binding globulin) bind
...
# receptors for progesterone preventing it


# from maintaining the uterus in a pregnant
...
# with its receptors and can not perform
...
- Toxin of cholera bacteria causes G-protein

# to lock in activated state in intestinal
...
# actively transport chloride (Na+ and water


# follow) into the lumen
...
# lethargy, brain damage, dwarfism, cretinism
...
# catabolism, poor wound healing

- buffalo hump & moon face = fat

# deposition between shoulders or in face with


# spindly legs due to low fat
...
- osmotic diuresis : blood glucose levels rise above transport

# maximum of kidney tubules, glucose remains in urine,


# osmolarity  and draws water into urine

- Transport maximum of glucose reabsorption
- kidney tubules can not reabsorb glucose fast enough

# if no insulin is present

- osmotic diuresis results due to excess glucose and
...
# glucose and periodic injections of insulin or insulin
...
- retina and kidneys (common in type I), atherosclerosis leading to
...
- Four chambers
- 2 superior and posterior atria receive returning

# blood

- 2 inferior and anterior ventricles pump outgoing
...
- pulmonary: from right ventricle into pulmonary
...
- Ventricles relax, pressure drops, semilunar

# valves close, AV valves open, blood flows
...
# rises, semilunar valves open, blood flows
...
# interruption of blood flow from vessel


# narrowing or occlusion

- Anastomoses defend against interruption

# by providing alternate blood pathways

- circumflex artery and right coronary artery

# combine to form posterior interventricular
...
- openings to coronary arteries, just above

# aortic semilunar valve, fill as blood surges
...
- Short, thick, branched cells, 50 to 100 m long

# and 10 to 20 m wide with one central nucleus

-  Sarcoplasmic reticulum, large T tubules
- must admit more Ca2+ from ECF during excitation
...
- Myogenic (automaticity) - heartbeat originates within
...
- Right and left bundle branches: divisions of AV bundle that

# enter interventricular septum and descend to apex
...
- slow Ca+2 channels open, let Ca +2 enter from outside cell

# and from storage in sarcoplasmic reticulum, while K+


# channels close

- Ca +2 binds to troponin to allow for actin-myosin cross-
...
- slow Ca+2 channels open, Ca+2 binds to fast Ca+2 channels

# on SR, releases Ca+2 into cytosol: contraction
...
# Extrasystole : note the inverted QRS complex, misshapen QRS and


# T and absence of a P wave preceding this contraction.
...
- systole (contraction) and diastole (relaxation) of both atria, plus
...
- Diastasis - sustained lower pressure, venous
...
- Measured from pulse
- Infants have HR of 120 beats per minute or
...
- Positive chronotropic agents  HR and

# negative chronotropic agents  HR

- Cardiac center of medulla oblongata
- an autonomic control center with 2 neuronal

# pools: a cardioacceleratory center
...
- stimulates sympathetic cardiac accelerator

# nerves to SA node, AV node and myocardium
...
- opens K+ channels in nodal cells, hyperpolarized, fire less frequently,

# HR slows down

- vagal tone: background firing rate holds HR to sinus rhythm
...
- Proprioceptors
- inform cardiac center about changes in activity, HR  before

# metabolic demands arise

- Baroreceptors
- pressure sensors in aorta and internal carotid arteries send

# continual stream of signals to cardiac center
...
-  CO2 (hypercapnia) causes  H+ levels,

# may create acidosis (pH < 7.35)
...
# during contraction,  CO matches  venous


# return

- Frank-Starling law of heart - SV EDV
- ventricles eject as much blood as they

# receive; more they are stretched ( preload)


# the harder they contract


# Contractility

- Contraction force for a given preload
- Tension caused by factors that adjust

# myocyte’s responsiveness to stimulation
...
-  SV allows heart to beat more slowly at rest, 40-
